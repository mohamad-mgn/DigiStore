...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_seller = models.BooleanField(default=False)  # نقش فروشنده / خریدار

    date_joined = models.DateTimeField(default=timezone.now)

    USERNAME_FIELD = "phone"
    REQUIRED_FIELDS = []  # چون phone تنها فیلد ضروری است
    ...
    @property
    def name(self):
        """اگر نام وارد نشده باشد، شماره نمایش داده می‌شود."""
